...
public class SyncManager {
    ...
    /**
     * Called from(访问) data model or background worker thread to indicate(指出) start of message add process
     * (add must complete on that thread before action transitions(转换) to new thread/stage)
