...
public class ExampleFrame_06 extends JFrame {
	...
	public ExampleFrame_06() {
		...
		Constraints lButtonCons = springLayout.getConstraints(lButton);// 获得“按钮L”的Constraints对象
		lButtonCons.setWidth(widthSP);// 设置控制组件宽度的弹簧
		lButtonCons.setHeight(heightST);// 设置控制组件高度的支柱
		Constraints rButtonCons = springLayout.getConstraints(rButton);// 获得“按钮R”的Constraints对象
