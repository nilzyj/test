...
public class UpdatePasswordDialog extends JDialog {
     ...
     * 
     */
    private static final long serialVersionUID = 5253149385392894427L;
        ...
        submitButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (oldPassword.length() == 0 || newPassword.length() == 0 || repeatPassword.length() == 0) {
                    JOptionPane.showMessageDialog(null, "请输入密码！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                    oldPasswordField.setText("      ");
                    newPasswordField.setText("      ");
                    repeatPasswordField.setText("      ");
                    return;
                ...
                if (oldPassword.equals(password)) {
                    if (newPassword.equals(repeatPassword)) {
                        ...
                        JOptionPane.showMessageDialog(null, "密码修改成功！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                        dispose();
                    } else {
                        JOptionPane.showMessageDialog(null, "您两次输入的新密码不一致，请确认后重新输入！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                        oldPasswordField.setText("      ");
                        newPasswordField.setText("      ");
                        repeatPasswordField.setText("      ");
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "您输入的原密码错误，请确认后重新输入！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                    oldPasswordField.setText("      ");
                    newPasswordField.setText("      ");
                    repeatPasswordField.setText("      ");
                }
