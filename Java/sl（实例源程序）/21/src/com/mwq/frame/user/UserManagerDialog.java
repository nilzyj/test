...
public class UserManagerDialog extends JDialog {
     ...
     * 
     */
    private static final long serialVersionUID = 5626684475179150311L;
        ...
        subButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (values[0].length() > 4) {
                    JOptionPane.showMessageDialog(null, "姓名最多只能为 4 个汉字！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                    nameTextField.setText("");
                    nameTextField.requestFocus();
                    return;
                }
                if (!Validate.execute("[0-9]{4}-[0-9]{1,2}-[0-9]{1,2}", values[2])) {
                ...
                if (values[0].length() > 20) {
                    JOptionPane.showMessageDialog(null, "密码最长不能超过 20 个字符！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                ...
                dao.iUser(values);
                JOptionPane.showMessageDialog(null, "用户添加完成！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                //
                nameTextField.setText("");
                manRadioButton.setSelected(true);
                birthdayTextField.setText("");
        ...
        delButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (i == 0) {
                    ...
                    JOptionPane.showMessageDialog(null, "删除用户成功！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                }
