...
public class DayDialog extends JDialog {
     ...
     * 
     */
    private static final long serialVersionUID = 5577869870241280275L;
    ...
    public DayDialog() {
        ...
        getContentPane().add(new FixedColumnTablePanel(tableColumnV, tableValueV, 4), BorderLayout.CENTER);
    }
