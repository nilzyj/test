...
public class TipWizardFrame extends JFrame {
     ...
     * 
     */
    private static final long serialVersionUID = -2889638533723209370L;
    ...
    public TipWizardFrame(final Vector user) {
        ...
        splitPane.setBorder(new TitledBorder(null, "", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));// 设置面版的边框
        ...
        numComboBox.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (rowCount > 0) {// 已经有开台
                    String selectedDeskNum = numComboBox.getSelectedItem().toString();// 获得“台号”下拉菜单中选中的台号
                    ...
                    if (needSelectedRow == -1) {// 选中的台号尚未开台，即新开台
                        ...
                        if (needSelectedRow != rightTable.getSelectedRow()) {
                            ...
                            leftTableValueV.removeAllElements();// 清空“签单列表”中的所有行
                            leftTableValueV.addAll(menuOfDeskV.get(needSelectedRow));// 将选中台号的签单列表添加到“签单列表”中
                            leftTableModel.setDataVector(leftTableValueV, leftTableColumnV);// 刷新“签单列表”
                            leftTable.setRowSelectionInterval(0);// 选中“签单列表”中的第一行
                        }
                    }
        ...
        delButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (lSelectedRow == -1) {// 未选中任何行
                    ...
                    String NEW = leftTable.getValueAt(lSelectedRow, 0).toString();// 获得选中菜品的新点菜标记
                    if (NEW.equals("")) {// 没有新点菜标记，不允许取消
                        JOptionPane.showMessageDialog(null, "很抱歉，该商品已经不能取消！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                        return;
                    } else {
                        int rSelectedRow = rightTable.getSelectedRow();// 获得“开台列表”中的选中行，即取消菜品的台号
                        int i = JOptionPane.showConfirmDialog(null,
                                "确定要取消“" + rightTable.getValueAt(rSelectedRow, 1) + "”中的商品“" + leftTable.getValueAt(lSelectedRow, 3) + "”？", "友情提示",
                                JOptionPane.YES_NO_OPTION);// 弹出提示信息确认是否取消
                        if (i == 0) {// 确认取消
        ...
        clueOnPanel.setBorder(new TitledBorder(null, "", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        checkOutPanel.setBorder(new TitledBorder(null, "", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
                    ...
                    if (NEW.equals("NEW")) {// 如果最后点菜被标记为“NEW”,则弹出提示
                        ...
                        if (realWages < expenditure) {// 如果实收金额小于消费金额，则弹出提示
                            if (realWages == 0.0f)
                                ...
                                JOptionPane.showMessageDialog(null, "实收金额不能小于消费金额！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                            ...
                            String[] values = { getNum(), rightTable.getValueAt(selectedRow, 1).toString(),
                                    Today.getDate() + " " + rightTable.getValueAt(selectedRow, 2), expenditureTextField.getText(), user.get(0).toString() };// 组织消费单信息
                            ...
                            JOptionPane.showMessageDialog(null, rightTable.getValueAt(selectedRow, 1) + " 结账完成！", "友情提示", JOptionPane.INFORMATION_MESSAGE);// 弹出结账完成提示
        ...
        aButtonPanel.setBorder(new TitledBorder(null, "", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        aTopButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                menuDialog.setLocation((screenSize.width - menuDialog.getWidth()) / 2, (screenSize.height - menuDialog.getHeight()) / 2);
        ...
        aCenterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                sortDialog.setLocation((screenSize.width - sortDialog.getWidth()) / 2, (screenSize.height - sortDialog.getHeight()) / 2);
        ...
        aBottomButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                ...
                deskNumDialog.setLocation((screenSize.width - deskNumDialog.getWidth()) / 2, (screenSize.height - deskNumDialog.getHeight()) / 2);
        ...
        dButtonPanel.setBorder(new TitledBorder(null, "", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        cButtonPanel.setBorder(new TitledBorder(null, "", TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, null, null));
        ...
        cTopButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                upDialog.setLocation((screenSize.width - upDialog.getWidth()) / 2, (screenSize.height - upDialog.getHeight()) / 2);
        ...
        cCenterButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                umDialog.setLocation((screenSize.width - umDialog.getWidth()) / 2, (screenSize.height - umDialog.getHeight()) / 2);
