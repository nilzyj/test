...
public class MenuDialog extends JDialog {
     ...
     * 
     */
    private static final long serialVersionUID = -3244330138372346654L;
    ...
    public MenuDialog() {
                ...
                for (int i = 0; i < fields.length; i++) {
                    ...
                    if (field.getType().equals(JTextField.class)) { // 只验证JTextField类型的属性
                        ...
                        if (textField.getText().trim().equals("")) { // 文本框为空
                            JOptionPane.showMessageDialog(null, "请填写商品“" + textField.getName() + "”！", "友情提示", JOptionPane.INFORMATION_MESSAGE);// 弹出需要输入信息的提示
        ...
        delButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int j = JOptionPane.showConfirmDialog(null, info, "友情提示", JOptionPane.YES_NO_OPTION);// 弹出确认提示框
                if (j == 0) {// 确认删除
        ...
        String columnNames[] = new String[] { "序 号", "编 号", "名 称", "助记码", "菜 系", "单 位", "单 价" };
