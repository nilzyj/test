...
public class SortDialog extends JDialog {
     ...
     * 
     */
    private static final long serialVersionUID = 2385094238267645856L;
    ...
    public SortDialog() {
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (sortName.equals("")) {// 查看是否输入了菜系名称
                    JOptionPane.showMessageDialog(null, "请输入菜系名称！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
                if (sortName.length() > 10) {// 查看菜系名称的长度是否超过了10个汉字
                    JOptionPane.showMessageDialog(null, "菜系名称最多只能为10个汉字！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
                if (dao.sSortByName(sortName).size() > 0) {// 查看该菜系名称是否已经存在
                    JOptionPane.showMessageDialog(null, "该菜系已经存在！", "友情提示", JOptionPane.INFORMATION_MESSAGE);
                    return;
                }
        ...
        delButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int j = JOptionPane.showConfirmDialog(null, "确定要删除菜系“" + delSortName + "”？", "友情提示", JOptionPane.YES_NO_OPTION);// 弹出确认提示
                if (j == 0) {// 确认删除
