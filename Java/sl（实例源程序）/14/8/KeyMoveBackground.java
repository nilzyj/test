...
public class KeyMoveBackground extends JFrame {
    ...
    public KeyMoveBackground() {
        ...
        setTitle("方向键移动背景"); // 设置窗体标题
        setBounds(100, 100, 500, 375);// 设置窗体位置和大小
        ...
        addKeyListener(new KeyAdapter() { // 为窗体添加按键事件监听适配器
